...
public class CrimeListFragment extends Fragment {
    ...
    //When this Fragment is resumed from a paused state such as returning to this fragments
    //hosting activity from some other activity, this method will get called, and we can use it to
    ...
    private void updateUI() {
        ...
        if (mAdapter == null) {
           ...
           //else, the adapter already exists so we just need to notify that the data set might have
           // changed. This will automatically update any data changes for us.
